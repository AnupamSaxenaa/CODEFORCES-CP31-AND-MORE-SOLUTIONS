...
void solve() {
    ...
    //lcm(1 to 9) = 2520 which is div by all 1to9 numbers so x*2520 will be my super fair number and from n to n+2520 i will find that number
     
    while (true)
    {
        int chk = is_fair(temp,temp);
        if(chk==1) 
        {
            cout<<temp<<endl;
            return;

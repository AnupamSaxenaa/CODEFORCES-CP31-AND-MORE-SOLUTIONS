...
void solve() {
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        sort(v.begin(),v.end());
        secondmini.push_back(v[1]);
        firstmini.push_back(v[0]);    
    }
    
    ll fm = *min_element(firstmini.begin(),firstmini.end());
    ll sm = *min_element(secondmini.begin(),secondmini.end());
    cout<<accumulate(secondmini.begin(),secondmini.end(),0LL)+fm-sm<<endl;
}
